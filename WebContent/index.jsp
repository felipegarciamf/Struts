...
<body>
	...
	<ol>
		...
		<li><s:url var="minhaurl" value="registration" /> <s:a
				href="%{minhaurl}">REGISTRAR USUÁRIO</s:a></li>
		<li><s:url var="LINK2" value="selectAction" /> <s:a
				href="%{LINK2}">Select</s:a></li>
		<li><s:url var="LINK3" value="set" /> <s:a href="%{LINK3}">Set</s:a></li>
		<li><s:url var="LINK4" value="inputTextArea" /> <s:a href="%{LINK4}">TextArea</s:a></li>
